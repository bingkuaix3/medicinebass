...
public class Jpush__do {
	...
	public static JSONObject push(JSONObject params, ActionContext context) throws Exception{
		...
		try{
			try {
				JSONObject ret = jpush.Push.push(params, context);

...
public class Weixin__do {
	...
	public static JSONObject service(JSONObject params, ActionContext context) throws Exception{
		...
		try{
			try {
				JSONObject ret = weixin.Service.service(params, context);
	...
	public static JSONObject jsapi(JSONObject params, ActionContext context) throws Exception{
		boolean selfContext = null==context;
		if(selfContext) context = new ActionContext(getDBConfig());
		if(params.containsKey(ActionContext.REQUEST)) context.put(ActionContext.REQUEST, params.get(ActionContext.REQUEST));
		if(params.containsKey(ActionContext.RESPONSE)) context.put(ActionContext.RESPONSE, params.get(ActionContext.RESPONSE));
		...
		try{
			try {
				JSONObject ret = weixin.WxMpJsApi.service(params, context);
				if(selfContext) context.commit();
				return ret;
			}catch (Exception e){
				try {
	...
	public static JSONObject notify(JSONObject params, ActionContext context) throws Exception{
		boolean selfContext = null==context;
		if(selfContext) context = new ActionContext(getDBConfig());
		if(params.containsKey(ActionContext.REQUEST)) context.put(ActionContext.REQUEST, params.get(ActionContext.REQUEST));
		if(params.containsKey(ActionContext.RESPONSE)) context.put(ActionContext.RESPONSE, params.get(ActionContext.RESPONSE));
		...
		try{
			try {
				JSONObject ret = weixin.WxPayNotify.service(params, context);
				if(selfContext) context.commit();
				return ret;
			}catch (Exception e){
				try {
	...
	public static JSONObject userinfo(JSONObject params, ActionContext context) throws Exception{
		boolean selfContext = null==context;
		if(selfContext) context = new ActionContext(getDBConfig());
		if(params.containsKey(ActionContext.REQUEST)) context.put(ActionContext.REQUEST, params.get(ActionContext.REQUEST));
		if(params.containsKey(ActionContext.RESPONSE)) context.put(ActionContext.RESPONSE, params.get(ActionContext.RESPONSE));
		...
		try{
			try {
				JSONObject ret = weixin.UserInfo.service(params, context);
				if(selfContext) context.commit();
				return ret;
			}catch (Exception e){
				try {
	...
	public static JSONObject weixin(JSONObject params, ActionContext context) throws Exception{
		boolean selfContext = null==context;
		if(selfContext) context = new ActionContext(getDBConfig());
		if(params.containsKey(ActionContext.REQUEST)) context.put(ActionContext.REQUEST, params.get(ActionContext.REQUEST));
		if(params.containsKey(ActionContext.RESPONSE)) context.put(ActionContext.RESPONSE, params.get(ActionContext.RESPONSE));
		...
		try{
			try {
				JSONObject ret = Weixin.wx(params, context);
				if(selfContext) context.commit();
				return ret;
			}catch (Exception e){
				try {
	...
	public static JSONObject ts(JSONObject params, ActionContext context) throws Exception{
		boolean selfContext = null==context;
		if(selfContext) context = new ActionContext(getDBConfig());
		if(params.containsKey(ActionContext.REQUEST)) context.put(ActionContext.REQUEST, params.get(ActionContext.REQUEST));
		if(params.containsKey(ActionContext.RESPONSE)) context.put(ActionContext.RESPONSE, params.get(ActionContext.RESPONSE));
		...
		try{
			try {
				JSONObject ret = Weixin.ts(params, context);
				if(selfContext) context.commit();
				return ret;
			}catch (Exception e){
				try {

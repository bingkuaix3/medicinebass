...
public class Attachment__do {
	...
	public static JSONObject simpleFileStore(JSONObject params, ActionContext context) throws Exception{
		...
		try{
			try {
				JSONObject ret = justep.SimpleFileStore.service(params, context);

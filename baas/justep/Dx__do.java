...
public class Dx__do {
	...
	public static JSONObject DuanXinCheck(JSONObject params, ActionContext context) throws Exception{
		...
		try{
			try {
				JSONObject ret = justep.Dx.DuanXinCheck(params, context);
	...
	public static JSONObject login(JSONObject params, ActionContext context) throws Exception{
		...
		try{
			try {
				JSONObject ret = justep.Dx.login(params, context);
				if(selfContext) context.commit();
				return ret;
			}catch (Exception e){
				try {
